...
class Registro_Form_Itenspedido extends Zend_Form
{
    ...
    public function init()
    {
		...
		$this->addElements(array($pedido, $item_pedido, $pedido_situacao, $data_situacao, $tipodocumentos, $tipoemolumento, $numeropaginas, $numerovias, $numeropessoas, $valor_documento, $emolumento, $valor_correio, $outras_despesas, $taxa_judiciaria, $funcivil, $total_custas, $submit));
    }
	
	public function pessoasCitadas(){
		...
		$this->addElements(array($tipo_identificacao_citado, $documento_citado, $nome_citado, $cep_citado, $endereco_citado, $telefone_citado, $complemento_citado, $bairro_citado, $numero_citado, $estado_citado, $cidade_citado, $notificar, $submit_temp, $submit_final));
	}
